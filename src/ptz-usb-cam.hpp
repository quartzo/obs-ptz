...
public:
    ...
    bool tilt(double value) {
        ...
        long tilt = std::clamp(static_cast<long>(now_pos.tilt * max.tilt),
            min.tilt, max.tilt);
    ...
    bool zoom(double value) {
        ...
        long zoom = std::clamp(static_cast<long>(now_pos.zoom * max.zoom),
            min.zoom, max.zoom);
    ...
    bool focus(double value) {
        ...
        long focus = std::clamp(static_cast<long>(now_pos.focus * max.focus),
            min.focus, max.focus);
